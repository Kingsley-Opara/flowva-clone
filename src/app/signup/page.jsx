    ...
    <div className='bg-[#8a17f8] min-h-[200vh] mb-5 mt-0 p-0 m-0 pb-20'>
        <div className='self-center flex flex-col place-content-center justify-center'>
            ...
            className='p-3 pt-15 flex flex-col self-center pb-20
             bg-white mt-14 w-120 h-fit rounded-xl max-md:w-80'>
                <div>
                ...
                <div className='px-5 mt-10 flex flex-col space-y-3'>
                ...
                <div className='px-5 mt-5 flex flex-col space-y-3 relative'>
                ...
                <div className='mt-8'>
                    <p className='text-gray-400 text-sm text-center'>
                        ...
                        <span className='text-purple-500 cursor-pointer hover:underline'> Log In </span>
                    </p>
